...
async function seed() {
  ...
  try {
    const tables = ['acessos_escolas','saldo_logistica','gastos_logistica','gastos_escolas','ocorrencia_comentarios','ocorrencia_videos','ocorrencia_fotos','ocorrencias','notas','plano_linhas','planos_formacao','reuniao_historico','reunioes','ausencias','eventos','tecnicos','escolas'];
